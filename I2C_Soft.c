...
void I2C_Write_Address_Write_One_Byte(char Device, 
        char Address, char Data_Out)
{
  I2C_Start();                                                          // Start I2C protocol
...
void I2C_Write_Cmd_Write_Data(char Device,
        char Cmd, char Data_Out)
{
  I2C_Start();                                                          // Start I2C protocol
  I2C_Write((Device << 1) | 0);                                         // Device address Write mode
  I2C_Write(Cmd);                                                       // Send Command
