...
{ 
    ...
    strcpy(txt, "ECE3301L S23 Final\0");         	// Text displayed 
...
void Update_Screen(void)
{
    ...
    if (ALARMEN == 1)                               // when the alarmen button is activated
    {   
    ...
    Fan_Set_Temp_Txt[0] = fan_set_temp/100 + '0';   // display the set temp of the LCD
    Fan_Set_Temp_Txt[1] = (fan_set_temp/10)%10 + '0';
    Fan_Set_Temp_Txt[2] = fan_set_temp%10 + '0';
    
    if (FAN == 1)                                   // when the fan is turned on/off
    {
    ...
    DC_Txt[0] = duty_cycle/100 + '0';               // print the duty cycle on the LCD
    DC_Txt[1] = (duty_cycle/10)%10  + '0';
    DC_Txt[2] = duty_cycle%10 + '0';    
    
    Volt_Txt[0] = ((int)  volt + '0');              // print the voltage on the LCD
    Volt_Txt[2] = ((int) (volt*10)%10 + '0'); 
    Volt_Txt[3] = ((int) (volt*100)%10 + '0'); 

    RPM_Txt[0] = rpm/1000 + '0';                    // print the rpm on the LCD
